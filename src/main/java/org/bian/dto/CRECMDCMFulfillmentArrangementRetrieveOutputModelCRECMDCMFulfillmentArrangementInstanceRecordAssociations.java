...
/**
 * CRECMDCMFulfillmentArrangementRetrieveOutputModelCRECMDCMFulfillmentArrangementInstanceRecordAssociations
 */
public class CRECMDCMFulfillmentArrangementRetrieveOutputModelCRECMDCMFulfillmentArrangementInstanceRecordAssociations   {
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The type of association (e.g. co-investor, legal) 
